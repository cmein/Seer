...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	label { width: 200px; }
	fieldset legend { padding-left: 220px; }
  ...
  <body>
	...
	<fieldset>
		...
		<div class="clearfix">
			...
			<div class="input"><input type="text" id="url" name="url" style="width: 450px;" title="URL" data-content="Typically this is a URL for a partial feed which we transform into a full-text feed. But it can also be a standard web page URL, in which case we'll extract its content and return it in a 1-item feed." /></div>
		</div>
	</fieldset>
	<fieldset>
	...
	<div class="clearfix">
	<label for="what">Extraction pattern:</label>
	<div class="input"><input type="text" id="what" name="what" value="auto" style="width: 250px;" /></div>
	</div>
	<?php } ?>	
	-->
	...
	<div class="input">
	<input type="text" id="key" name="key" class="medium" <?php if ($options->key_required) echo 'required'; ?> title="Access Key" data-content="<?php echo ($options->key_required) ? 'An access key is required to generate a feed' : 'If you have an access key, enter it here.'; ?>" />
	</div>
	</div>
	<?php } ?>
	<div class="clearfix">
	...
	<div class="input">
	<?php
	// echo '<select name="max" id="max" class="medium">'
	...
	?>	
	<input type="text" name="max" id="max" class="mini" value="<?php echo $options->default_entries; ?>" title="Feed item limit" data-content="Set the maximum number of feed items we should process. The smaller the number, the faster the new feed is produced.<br /><br />If your URL refers to a standard web page, this will have no effect: you will only get 1 item.<br /><br /> <?php echo $msg_more; ?>" />
	...
	<div class="input">
	<select name="links" id="links" class="medium" title="Link handling" data-content="By default, links within the content are preserved. Change this field if you'd like links removed, or included as footnotes.">
	...
	<div class="clearfix">
	<label for="exc">If extraction fails</label>
	<div class="input">
	...
	<div class="actions">
		<input type="submit" id="sudbmit" name="submit" value="Create Feed" class="btn primary" />
	</div>
	</form>
	...
	<ol>
		...
		<li>Enter a feed or article URL in the form above and click 'Create Feed' <a href="http://help.fivefilters.org/customer/portal/articles/223127-suggested-feeds-and-articles" rel="twipsy" title="Need suggestions? We've got a number of feeds and articles you can try" class="label">?</a></li>
